            ...
            <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 h-full flex items-center">
              ...
              >
                <h1 className="text-4xl md:text-5xl font-bold mb-6">
                  Pioneering Digital Innovation Since 2025
                </h1>
                <p className="text-lg text-gray-200">
                  Transforming visions into impactful digital experiences
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-3xl font-bold text-gray-900">
                PDSN Media Redefining Digital Possibilities
              </h2>
        ...
        <section className="py-20 bg-gray-50">
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-gray-600">
                To empower businesses through innovative, data-driven digital solutions that create meaningful connections and measurable impact. We strive to be the catalyst for our clients&#39; success in an increasingly digital world.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600">
                To be the global leader in transformative digital experiences, pioneering technologies that bridge the gap between brands and their audiences through creativity, innovation, and strategic insight.
              </p>
            </div>
          </motion.div>
        </section>
              ...
              {["🚀","🔒","🔄","💎","🏆","🤝","🌱"].map((icon, idx) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">{["Innovation","Integrity","Adaptability","Customer Focus","Excellence","Collaboration","Sustainability"][idx]}</h3>
                ...
                {["Sanchit Bhan","Dheeraj Bhat"].map((name, idx) => (
                  ...
                  >
                    ...
                    <div className="p-6 text-center">
                      ...
                      <p className="text-blue-600 mt-1">{["CEO & Founder","Co-Founder & CFO"][idx]}</p>
                      <p className="text-gray-600 mt-4">{["Digital media strategist with 15+ years experience","Award-winning DOOH campaign specialist"][idx]}</p>
                      <a
                        href={["https://www.linkedin.com/in/sanchit-bhan","https://www.linkedin.com/in/dheeraj-bhat"][idx]}
                        target="_blank"
