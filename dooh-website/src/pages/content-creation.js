...
const serviceBlocks = [
  ...
  },
  {
    ...
    type: "image",
    media: ["/images/cgi1.jpg", "/images/cgi2.jpg"],
  },
  {
...
export default function ContentCreationPage() {
  return (
    <main className="bg-[#0e0f1a] text-white">
      <section className="relative py-32 px-6 text-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#00acd7]/80 to-[#341f9b]/90" />
        </div>
        <motion.div
      ...
      <section id="services" className="py-24 px-6 space-y-24">
        {serviceBlocks.map((service, index) => (
          ...
          >
            ...
            <p className="text-base text-gray-400 mb-8">{service.brief}</p>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {service.media.map((src, i) =>
                service.type === "video" ? (
                  <video key={i} src={src} controls className="rounded-xl shadow-lg w-full h-auto" />
                ) : (
                  <Image key={i} src={src} alt={service.title} width={800} height={500} className="rounded-xl shadow-lg w-full h-auto object-cover" />
                )
              )}
            </div>
              ...
              <div className="py-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  {["model1.glb", "model2.glb"].map((model, i) => (
                    <div key={i} className="relative w-full aspect-square bg-[#181a2a] rounded-xl shadow-md">
      ...
      <section className="text-center py-20 bg-gradient-to-r from-[#00acd7] to-[#341f9b]">
        ...
        <Link href="/contact" className="bg-white text-[#341f9b] px-6 py-3 rounded-md font-semibold hover:bg-blue-100 transition">
          Start Your Project
        </Link>
      </section>
    </main>
