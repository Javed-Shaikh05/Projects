        ...
        >
          ...
          >
            <p className="text-gray-700">
              <strong>Ready to amplify your brand’s presence across cities?</strong><br />
              Leverage our DOOH network to connect with audiences at the right place and the right time.
            </p>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Link href="/" className="h-12 px-5 rounded-md flex items-center bg-blue-600 text-white hover:bg-blue-700 transition">
                Let’s talk
              </Link>
            </motion.div>
          </motion.div>
