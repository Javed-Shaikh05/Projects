...
const Navbar = () => {
  ...
  <span className="text-lg font-bold text-indigo-950">
    PDSN<span className="align-super text-[10px] text-gray-500 ml-1">Ⓣ</span>
  </span>
</Link>
            ...
            <ul className="flex flex-col gap-6 text-gray-700 lg:flex-row lg:items-center lg:gap-6">
              {[
                ...
                <li key={href}>
                  <Link
                    href={href}
                    className={`py-2.5 transition duration-300 ${
                      isActive(href)
              ...
              <li className="relative group select-none">
                <span
                  className={`cursor-pointer py-2.5 transition ${
                    isActive('/programmatic-dooh')
                      ? 'bg-gradient-to-r from-[#00acd7] to-[#341f9b] bg-clip-text text-transparent'
          ...
          >
            <span
              className={`block h-0.5 w-6 rounded bg-gray-800 transition-transform duration-300 ${
                navIsOpened ? 'translate-y-[7px] rotate-45' : ''
              }`}
            />
            <span
              className={`mt-2 block h-0.5 w-6 rounded bg-gray-800 transition-transform duration-300 ${
                navIsOpened ? '-translate-y-[7px] -rotate-45' : ''
              }`}
            />
          </button>
